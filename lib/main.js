    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (ret_code != 1) {
                ...
                octokit.pulls.create(Object.assign(Object.assign({}, github.context.repo), { title: 'Julia Package Butler Updates', head: 'julia-pkgbutler-updates', base: 'master', body: 'The Julia Package Butler suggests these changes.' }));
            }
        }
        catch (error) {
