...
const uuids = __importStar(require("uuid/v4"));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (ret_code != 1) {
                ...
                yield exec.exec('git', ['commit', '-m', '"Julia Package Butler updates"']);
                let ret_code2 = yield exec.exec('git', ['diff', LOCAL_BRANCH_NAME, 'remotes/origin/julia-pkgbutler-updates', '--exit-code', '--quiet']);
                if (ret_code2 != 0) {
