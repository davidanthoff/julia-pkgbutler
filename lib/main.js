...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const LOCAL_BRANCH_NAME = (0, uuid_1.v4)();
            ...
            if (ret_code != 0) {
                ...
                if (ret_code2 != 0) {
                    ...
                    try {
                        yield octokit.rest.pulls.create(Object.assign(Object.assign({}, github.context.repo), { title: 'Julia Package Butler Updates', head: 'julia-pkgbutler-updates', base: 'main', body: 'The Julia Package Butler suggests these changes.' }));
                        ...
                        try {
                            yield octokit.rest.pulls.create(Object.assign(Object.assign({}, github.context.repo), { title: 'Julia Package Butler Updates', head: 'julia-pkgbutler-updates', base: 'master', body: 'The Julia Package Butler suggests these changes.' }));
                            console.log('Julia Package Butler succesfully created a new PR.');
                        }
                        catch (error) {
